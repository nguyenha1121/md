...
console.log("some jquery plugin"),$(document).ready(function(){$(".range-example-single").asRange({range:!0,limit:!0,format:function(s){return"$"+s},onChange:function(s){console.log(s[0],"-",s[1])}}),$(".filter button").click(function(s){$(this).next().toggle()}),$(".hnn-imgs").slick({slidesToShow:5,slidesToScroll:1,nextArrow:'<a class="hnn-arrow hnn-right" href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>',prevArrow:'<a class="hnn-arrow hnn-left" href="#"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>',responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,dots:!1}},{breakpoint:600,settings:{arrows:!1,slidesToShow:1,slidesToScroll:1,arrows:!1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1}}]}),$(".slider-footer").slick({dots:!1,infinite:!0,adaptiveHeight:!0,slidesToShow:5,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,dots:!1}},{breakpoint:600,settings:{arrows:!1,slidesToShow:1,slidesToScroll:1}},{breakpoint:480,settings:{arrows:!1,slidesToShow:1,slidesToScroll:1,unslick:!0}}],adaptiveHeight:!0,nextArrow:'<a class="hn-5-nextx" href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>',prevArrow:'<a class="hn-5-prevx" href="#"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>'}),$(".hnn-slider-cat").slick({dots:!1,infinite:!0,adaptiveHeight:!0,slidesToShow:5,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,dots:!1}},{breakpoint:600,settings:{arrows:!1,slidesToShow:1,slidesToScroll:1}},{breakpoint:480,settings:{arrows:!1,slidesToShow:1,slidesToScroll:1,unslick:!0}}],adaptiveHeight:!0,nextArrow:'<a class="hn-5-next" href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>',prevArrow:'<a class="hn-5-prev" href="#"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>'}),$(".arc").click(function(s){var e=$(this).next();e.toggle()}),$(".navbar-toggle").click(function(){var s=$(this).attr("aria-expanded");console.log(s),"true"==s?$(".ct-brand").css("display","block"):$(".ct-brand").css("display","none")}),$(".hide-list-wr").click(function(){$(this).next().toggle("slow")})});
$(".hovers ").hover(function(){console.log("ssss");var t=$(this).attr("src"),r=$(this).attr("data-origin");$("#hover-to").attr("src",t),$("#hover-to").attr("data-origin",r)});